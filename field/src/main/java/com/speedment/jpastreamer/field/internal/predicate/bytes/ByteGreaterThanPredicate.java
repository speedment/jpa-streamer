 ...
 * @since  3.0.0
 */
public final class ByteGreaterThanPredicate<ENTITY>
extends AbstractFieldPredicate<ENTITY, HasByteValue<ENTITY>>
implements HasArg0<Byte> {
    
    private final byte value;
    
    public ByteGreaterThanPredicate(HasByteValue<ENTITY> field, byte value) {
    ...
    @Override
    public ByteLessOrEqualPredicate<ENTITY> negate() {
