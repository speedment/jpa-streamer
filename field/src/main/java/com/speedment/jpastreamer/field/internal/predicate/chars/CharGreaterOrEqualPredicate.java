 ...
 * @since  3.0.0
 */
public final class CharGreaterOrEqualPredicate<ENTITY>
extends AbstractFieldPredicate<ENTITY, HasCharValue<ENTITY>>
implements HasArg0<Character> {
    
    private final char value;
    
    public CharGreaterOrEqualPredicate(HasCharValue<ENTITY> field, char value) {
    ...
    @Override
    public CharLessThanPredicate<ENTITY> negate() {
