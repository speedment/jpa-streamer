 ...
 * @since  3.0.0
 */
public final class CharGreaterThanPredicate<ENTITY>
extends AbstractFieldPredicate<ENTITY, HasCharValue<ENTITY>>
implements HasArg0<Character> {
    
    private final char value;
    
    public CharGreaterThanPredicate(HasCharValue<ENTITY> field, char value) {
    ...
    @Override
    public CharLessOrEqualPredicate<ENTITY> negate() {
