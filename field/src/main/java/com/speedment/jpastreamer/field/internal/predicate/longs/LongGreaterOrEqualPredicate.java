 ...
 * @since  3.0.0
 */
public final class LongGreaterOrEqualPredicate<ENTITY>
extends AbstractFieldPredicate<ENTITY, HasLongValue<ENTITY>>
implements HasArg0<Long> {
    
    private final long value;
    
    public LongGreaterOrEqualPredicate(HasLongValue<ENTITY> field, long value) {
    ...
    @Override
    public LongLessThanPredicate<ENTITY> negate() {
