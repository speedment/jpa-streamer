 ...
 * @since  3.0.0
 */
public final class LongNotEqualPredicate<ENTITY>
extends AbstractFieldPredicate<ENTITY, HasLongValue<ENTITY>>
implements HasArg0<Long> {
    
    private final long value;
    
    public LongNotEqualPredicate(HasLongValue<ENTITY> field, long value) {
    ...
    @Override
    public LongEqualPredicate<ENTITY> negate() {
