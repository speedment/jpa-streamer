...
import com.speedment.jpastreamer.streamconfiguration.standard.StandardStreamConfigurationFactory;
...
module jpastreamer.streamconfiguration.standard {
    ...
    provides StreamConfigurationFactory with StandardStreamConfigurationFactory;
}
