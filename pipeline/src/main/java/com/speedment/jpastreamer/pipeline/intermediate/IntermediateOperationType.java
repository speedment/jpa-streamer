...
public enum IntermediateOperationType {
    ...
    MAP_TO_SAME(PRESERVES_ORDER, PRESERVES_SIZE, PRESERVES_TYPE, PRESERVES_STREAM_TYPE),
    ...
    SORTED(PRESERVES_ORDER, PRESERVES_TYPE, PRESERVES_STREAM_TYPE, MODIFIES_SORTED),
